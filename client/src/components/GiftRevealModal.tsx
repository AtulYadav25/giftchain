...
export default function GiftRevealModal({ isOpen, onClose, gift, variant }: GiftRevealModalProps) {
    ...
    const triggerConfetti = () => {
        // Only trigger confetti on desktop
                ...
                {expandedView !== 'none' ? (
                    ...
                    >
                        <button
                            ...
                            className="absolute top-4 right-4 z-50 p-3 bg-white hover:bg-slate-100 rounded-full border-2 border-slate-900 shadow-[4px_4px_0_0_rgba(15,23,42,1)] hover:scale-110 active:scale-90 transition-all"
                        >
                            <X size={24} strokeWidth={3} />
                        </button>

                        {expandedView === 'wrapper' ? (
                            <motion.img
                                src={gift.wrapper}
                                initial={{ borderRadius: "2rem" }}
                                className="w-full h-auto max-h-[80vh] object-contain bg-white border-[4px] border-slate-900 shadow-[12px_12px_0_0_rgba(15,23,42,1)] rounded-[2rem]"
                                alt="Full size wrapper"
                            />
                        ) : (
                            <motion.div
                            ...
                            >
                                ...
                                <p className="text-slate-900 font-lexend font-bold text-2xl leading-loose whitespace-pre-wrap">
                                    "{gift.message}"
                                </p>
                            </motion.div>
                        )}
                        ...
                        <button
                            onClick={() => setExpandedView('none')}
                            className="mt-8 px-8 py-3 bg-white text-slate-900 border-[3px] border-slate-900 rounded-2xl font-black text-lg shadow-[6px_6px_0_0_rgba(15,23,42,1)] hover:translate-y-[-2px] active:translate-y-[2px] active:shadow-none transition-all"
                        >
                            Back to Card
                        </button>
                    </motion.div>
                        ...
                        >
                            ...
                            <div className="p-8 pb-10 flex flex-col items-center gap-6 bg-white relative">
                                ...
                                <div
                                    ...
                                    onClick={() => setExpandedView('wrapper')}
                                >
