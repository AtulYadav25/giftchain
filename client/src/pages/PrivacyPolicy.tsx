...
const PrivacyPolicy = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Privacy Policy — Giftchain</title>
                <meta name="description" content="Read our privacy policy to understand how we handle your personal information and protect your privacy." />
            </Helmet>
