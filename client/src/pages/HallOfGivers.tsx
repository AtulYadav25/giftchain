...
export default function HallOfGivers() {
    ...
    const { topGivers } = useAuthStore((state) => state);
    ...
    return (
        <>
            <Helmet>
                <title>Hall Of Givers — Giftchain</title>
                <meta name="description" content="View our hall of givers, celebrating the legends who spread the most joy." />
            </Helmet>
